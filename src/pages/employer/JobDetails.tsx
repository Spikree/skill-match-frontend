              ...
              <div className="p-4 sm:p-8">
                ...
                >
                  <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 flex items-center">
                    <Briefcase className="mr-2 sm:mr-3 text-blue-600 w-6 h-6 sm:w-8 sm:h-8" />
                    {job.title}
                  </h1>
                  <span className="px-3 py-1 sm:px-4 sm:py-2 bg-blue-100 text-blue-800 rounded-full text-xs sm:text-sm font-medium">
                    {job.status}
                  </span>
                </motion.div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
                  {[
                    ...
                    { 
                      icon: <DollarSign className="w-5 h-5 mr-3 text-green-600" />, 
                      title: "Budget", 
                      value: job.budget 
                    },
                    { 
                ...
                <div className="space-y-6">
                  ...
                  >
                    <h2 className="text-lg sm:text-xl font-semibold mb-4 flex items-center text-gray-900">
                      <FileText className="mr-2 sm:mr-3 text-blue-600" />
                      Job Description
                    </h2>
                  ...
                  <div>
                    <h2 className="text-lg sm:text-xl font-semibold mb-4 flex items-center text-gray-900">
                      <Tag className="mr-2 sm:mr-3 text-blue-600" />
                      Required Skills
                    </h2>
                    <div className="flex flex-wrap gap-2">
                      {job.skillsRequired.map(skill => (
                        <motion.span 
                          ...
                          initial={{ scale: 0 }}
                          animate={{ scale: 1 }}
                          className="px-2 py-1 sm:px-4 sm:py-2 bg-blue-100 text-blue-800 rounded-lg text-xs sm:text-sm font-medium hover:bg-blue-200 transition-colors"
                        >
                          {skill}
                        </motion.span>
                      ))}
                        ...
                        <div className="p-4 sm:p-6">
                          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 gap-4">
                            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-4">
                              ...
                              <span className={`flex items-center gap-2 px-3 py-1 sm:px-4 sm:py-2 rounded-lg text-xs sm:text-sm font-medium ${
                          ...
                          <div className="bg-white p-3 sm:p-4 rounded-lg">
                            <p className="text-xs sm:text-sm text-gray-700 leading-relaxed">{proposal.coverLetter}</p>
                          </div>
                        </div>
                      </motion.div>
                    ))}
